...
- [SBOM Overview](/en/docs/sbom_guide/1-overview/): An overview of what an SBOM is and why it is needed, covering software supply chain threats and the benefits an SBOM provides.
- [Standards and Formats](/en/docs/sbom_guide/2-standards/): Compares SPDX and CycloneDX, the two standard formats for expressing an SBOM in a machine-readable form.
- [Regulatory Trends](/en/docs/sbom_guide/3-regulation/): Summarizes the regulatory standing of SBOM across jurisdictions, and the US executive order and federal procurement pathway.
- [Adoption Roadmap](/en/docs/sbom_guide/4-adoption/): Summarizes the activities organizations undertake to build an SBOM program in stages, from establishing the foundation to operational maturity.
- [Tools and Automation](/en/docs/sbom_guide/5-tools/): Covers SBOM generation, management, and scanning tools, and where automation ends and human responsibility begins.
- [Vulnerability Management and VEX](/en/docs/sbom_guide/6-vulnerability/): Covers how to link an SBOM to vulnerability data for tracking, and the VEX/CSAF framework for exchanging exploitability information.
- [Sharing and Governance](/en/docs/sbom_guide/7-governance/): Summarizes SBOM access control and disclosure scope, secure sharing channels, and roles-and-responsibilities governance.
- [Recommendations and Checklist](/en/docs/sbom_guide/8-checklist/): Collects the key recommendations from the preceding sections and provides a checklist for reviewing SBOM adoption.
