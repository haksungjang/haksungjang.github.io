...
- [Minimum Elements of an SBOM](/en/docs/sbom_guide/2-standards/1-minimum-elements/): Covers the data fields an SBOM must contain, from the NTIA 2021 minimum elements to the CISA 2025 revision draft.
- [Identifiers and Licenses](/en/docs/sbom_guide/2-standards/2-identifiers/): Covers the PURL, CPE, and SWID identifiers used to consistently point to components, and how to notate SPDX license identifiers.
