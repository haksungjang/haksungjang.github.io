...
![Attendees listening to a presentation at the 17th KWG offline meeting](./Untitled_1.png)
...
![Jeongsuk Park (ETRI) presenting an analysis of the Getty Images v. Stability AI lawsuit](./Untitled_5.png)
...
![Slide summarizing the current state of AI-related legislation](./Untitled_6.png)
...
![Slide summarizing approaches to AI-related open source compliance](./Untitled_7.png)
...
![Hyunji Im (Kakao) presenting how different tools analyze dependencies](./Untitled_8.png)
...
![Slide comparing dependency-analysis approaches across FOSSA, FOSSLight, ORT, and OLIVE Platform](./Untitled_9.png)
...
![Soim Kim (LG Electronics) introducing the OSORI project](./Untitled_10.png)
...
![Slide on the OSORI project's open source information schema and roadmap](./Untitled_11.png)
...
![Kyungae Kim (LG Electronics) presenting the FOSSLight roadmap](./Untitled_12.png)
...
![Slide on FOSSLight's 2023 roadmap: improved vulnerability handling, stronger SBOM support, and UX improvements](./Untitled_13.png)

### Have You Tried OLIVE Lately? (Kakao, Eunkyung Hwang)

[OLIVE Platform](https://olive.kakao.com/) is an open source license verification service developed by Kakao, which anyone can use for free with just a Kakao account. Eunkyung Hwang of Kakao introduced the key features of the OLIVE Platform.

![Eunkyung Hwang (Kakao) introducing the main features of OLIVE Platform](./Untitled_14.png)
...
![Slide explaining the OLIVE CLI feature that avoids exposing source code](./Untitled_15.png)
...
![Hyunmin Han (Kakao) introducing onot's new features](./Untitled_16.png)
...
![Slide on onot's new features: File-level info extraction, multi-license notation, and Windows GUI support](./Untitled_17.png)
...
![LINE Plus staff presenting the souvenirs and raffle prizes they prepared](./Untitled_18.png)
