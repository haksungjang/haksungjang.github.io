...
<div class="alert alert-success" role="alert"><div class="h4 alert-heading" role="heading">OpenChain 규격과 KWG 실천 가이드의 역할 분담</div>
...
<div class="alert alert-info" role="alert"><div class="h4 alert-heading" role="heading">표기 규칙 — [규격 요구] vs [본 가이드 권고]</div>
...
<div class="alert alert-info" role="alert"><div class="h4 alert-heading" role="heading">조항 번호에 관한 안내</div>
...
<div class="alert alert-info" role="alert"><div class="h4 alert-heading" role="heading">생성은 도구로, 해석은 사람으로</div>
...
<div class="alert alert-info" role="alert"><div class="h4 alert-heading" role="heading">ISO/IEC 5230 · 42001과의 관계</div>


- **ISO/IEC 5230(라이선스 컴플라이언스)**: AI SBOM 가이드는 5230 방법론을 그대로 물려받았다.
  이미 5230 체계를 갖춘 조직은 정책, 역량, 자원 같은 프로그램 기반을 재사용하고 AI 확장 영역만
  보강하면 된다. [ISO/IEC 5230 준수 가이드](https://openchain-project.github.io/OpenChain-KWG/guide/iso5230_guide/) 참고.
- **ISO/IEC 42001(AI 관리 시스템)**: AI SBOM 형식(SPDX 3.0 AI Profile, CycloneDX ML-BOM)과 생성
  도구의 기술 상세는 [ISO/IEC 42001 가이드 — AI SBOM](https://openchain-project.github.io/OpenChain-KWG/guide/iso42001_guide/4-operation/2-ai-sbom/)에서
...
- [프로그램 기반](/docs/ai-sbom_guide/1-program-foundation/): AI SBOM 컴플라이언스 프로그램의 기반을 세우는 단계다. 정책, 역량, 인지, 범위를 갖춘다.
- [AI 확장 프로세스](/docs/ai-sbom_guide/2-ai-extension/): 코드를 넘어 모델과 가중치, 데이터셋까지 다루는 AI 고유의 라이선스, 투명성, SBOM 프로세스를 구축하는 단계다.
- [운영](/docs/ai-sbom_guide/3-relevant-tasks/): 외부 컴플라이언스 문의에 대응하는 창구를 만들고, 프로그램에 책임과 자원을 배정하는 단계다.
- [거버넌스](/docs/ai-sbom_guide/4-governance/): AI 시스템 수명주기 전반의 거버넌스 프레임워크를 갖추고, 신흥 AI 규제를 반영하는 단계다.
- [도구](/docs/ai-sbom_guide/5-tools/): AI SBOM을 생성하고 분석하는 오픈소스 도구의 주요 기능과 사용법을 실행 화면과 함께 안내한다.
