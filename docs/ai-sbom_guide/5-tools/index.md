...
관리하는 도구([Dependency-Track](https://openchain-project.github.io/OpenChain-KWG/guide/tools/7-dependency-track/))를 조합한다.

---

Section pages:

- [OWASP AIBOM Generator](/docs/ai-sbom_guide/5-tools/1-aibom-generator/): Hugging Face 모델에서 CycloneDX 형식 AI SBOM을 생성하고 완전성 점수를 매기는 OWASP 도구의 사용법을 실행 화면과 함께 안내한다.
- [cdxgen](/docs/ai-sbom_guide/5-tools/2-cdxgen/): 프로젝트와 모델에서 CycloneDX SBOM을 생성하는 OWASP cdxgen의 AI BOM 모드 사용법을 실행 출력과 함께 안내한다.
- [모델·컨테이너 스캐너 (Lab700x, Trivy, Syft)](/docs/ai-sbom_guide/5-tools/3-scanners/): AI 모델 바이너리와 추론 서버, AI 패키지를 분석하는 보안 스캐너의 주요 기능과 사용법을 소개한다.
