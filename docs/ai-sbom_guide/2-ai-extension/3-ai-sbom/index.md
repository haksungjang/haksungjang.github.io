...
<div class="alert alert-warning" role="alert"><div class="h4 alert-heading" role="heading">실행 결과가 보여주는 것 — 생성은 도구, 검증은 사람</div>
...
구체 필드와 생성 도구의 기술 상세는 [ISO/IEC 42001 가이드 — AI SBOM](https://openchain-project.github.io/OpenChain-KWG/guide/iso42001_guide/4-operation/2-ai-sbom/)에서
다룬다.
...
- AI SBOM 형식·생성 도구 기술 상세: [ISO/IEC 42001 가이드 — AI SBOM](https://openchain-project.github.io/OpenChain-KWG/guide/iso42001_guide/4-operation/2-ai-sbom/)
- SBOM 관리 도구: [Dependency-Track](https://openchain-project.github.io/OpenChain-KWG/guide/tools/7-dependency-track/), [cdxgen + Dependency-Track 연동](https://openchain-project.github.io/OpenChain-KWG/guide/tools/8-cdxgen-dt/)
