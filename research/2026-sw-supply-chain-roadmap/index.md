# 한국 SW 공급망 보안 로드맵, 글로벌 규제와 얼마나 정렬돼 있나 — 독립 분석

> 정부가 2026년 6월 24일 공개한 「SW 공급망 보안 강화 로드맵」을 글로벌 규제와의 정합성 관점에서 분석한다. SBOM·시범인증·상호인정을 핵심 수단으로 삼은 한국 정책이 미국·EU 제도를 어떻게 뒤따르는지, 수출·공공·중소기업이 무엇을 준비해야 하는지를 다룬다.
