...
이 체크리스트는 자사 개발팀이 외부 AI 모델이나 데이터셋을 가져와 활용할 때, AI를 위한 자재 명세서(AI Bill of Materials, AI BOM)를 근거로 투명성과 위험을 점검하는 기준입니다. 확인 항목은 [「AI BOM 필드 요구사항 매트릭스」](/research/2026-ai-bom-requirements/)의 도입 열에서 도출했습니다.
