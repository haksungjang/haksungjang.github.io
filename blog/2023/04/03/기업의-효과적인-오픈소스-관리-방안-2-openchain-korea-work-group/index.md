...
![17차 KWG 오프라인 모임 현장에서 발표를 듣는 참석자들](./Untitled_1.png)
...
![Shane Coughlan이 OpenChain Project의 글로벌 동향을 발표하는 모습](./Untitled_2.png)
...
![Shane Coughlan이 KWG 멤버들에게 나눠준 기념품](./Untitled_3.png)
...
![장학성(SK텔레콤)이 OpenChain 보안 표준을 발표하는 모습](./Untitled_4.png)
...
![박정숙(ETRI)이 Getty Images v. Stability AI 소송을 분석하는 발표 모습](./Untitled_5.png)
...
![AI 관련 법률 제정 현황을 정리한 발표 슬라이드](./Untitled_6.png)

박정숙님은 AI 관련 법률 제정 현황을 분석하고, 이를 기반으로 AI 관련 오픈소스 컴플라이언스 대응 방안을 모색하여 공유해주셨습니다.

![AI 관련 오픈소스 컴플라이언스 대응 방안을 정리한 발표 슬라이드](./Untitled_7.png)
...
![임현지(카카오)가 오픈소스 분석 도구별 의존성 분석 방식을 발표하는 모습](./Untitled_8.png)

대표적인 오픈소스 분석 도구인 FOSSA, FOSSLight, ORT (OSS Review Toolkit), OLIVE Platform 별로 의존성 분석 방식을 파악하여 공유하였습니다. 

![FOSSA, FOSSLight, ORT, OLIVE Platform의 의존성 분석 방식을 비교한 슬라이드](./Untitled_9.png)
...
![김소임(LG전자)이 OSORI 프로젝트를 소개하는 모습](./Untitled_10.png)
...
![OSORI 프로젝트의 오픈소스 정보 스키마와 향후 로드맵을 정리한 슬라이드](./Untitled_11.png)
...
![김경애(LG전자)가 FOSSLight Roadmap을 발표하는 모습](./Untitled_12.png)

FOSSLight Project는 2023년 보안 취약점 기능을 개선하고, SBOM 기능 강화, UX개선 등의 로드맵을 가지고 있습니다. 

![FOSSLight의 2023년 로드맵(보안 취약점 기능 개선, SBOM 기능 강화, UX 개선)을 정리한 슬라이드](./Untitled_13.png)
...
![황은경(카카오)이 OLIVE Platform의 주요 기능을 소개하는 모습](./Untitled_14.png)

OLIVE Platform은 소스 코드 노출이 우려되는 경우에도 안심하고 사용할 수 있는 OLIVE CLI 기능이 추가되어 보안에 민감한 금융권에서도 도입될 수 있었습니다. 

![소스 코드 노출 우려 없이 쓸 수 있는 OLIVE CLI 기능을 설명하는 슬라이드](./Untitled_15.png)
...
![한현민(카카오)이 onot의 신규 기능을 소개하는 모습](./Untitled_16.png)
...
![onot의 File 정보 추출, Multi License 표기, Windows GUI 지원 등 신규 기능을 정리한 슬라이드](./Untitled_17.png)

## 글을 마치며

3년여만에 오프라인으로 모인 모임은 짧은 시간이 아쉬울 정도로 알찼습니다. 멋진 장소와 기념품, 추첨 상품까지 준비해준 라인플러스 이서연 님, 김동혁 님께 다시 한번 감사드립니다. 

![라인플러스 담당자가 준비한 기념품과 추첨 상품을 소개하는 모습](./Untitled_18.png)
