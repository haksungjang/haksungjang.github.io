...
![Featured image for SPDX 3.0](./featured_SPDX30.png)
...
1. **Automated SBOM generation**
    ...
    - This enables "machine-speed" SBOM generation, allowing SBOMs to be updated instantly in step with the software release cycle.
