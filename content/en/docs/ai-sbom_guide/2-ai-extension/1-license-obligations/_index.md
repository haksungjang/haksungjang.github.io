...
- 자동 스캔 도구: [도구 — FOSSology](https://openchain-project.github.io/OpenChain-KWG/guide/tools/1-fossology/), [SCANOSS](https://openchain-project.github.io/OpenChain-KWG/guide/tools/9-scanoss/)
- AI 모델·데이터셋 라이선스 전략: [기업 오픈소스 관리 가이드 — AI 컴플라이언스](https://openchain-project.github.io/OpenChain-KWG/guide/opensource_for_enterprise/7-ai-compliance/)
