...
- 오픈소스 정책의 기본 구조: [ISO/IEC 5230 준수 가이드 — 3.1.1 정책](https://openchain-project.github.io/OpenChain-KWG/guide/iso5230_guide/1-program-foundation/1-policy/)
- AI 라이선스 관리 전략: [기업 오픈소스 관리 가이드 — AI 컴플라이언스](https://openchain-project.github.io/OpenChain-KWG/guide/opensource_for_enterprise/7-ai-compliance/)
