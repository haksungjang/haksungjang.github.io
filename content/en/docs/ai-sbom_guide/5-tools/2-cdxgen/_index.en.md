...
type: docs
categories: ["guide"]
tags: ["AI SBOM", "cdxgen", "CycloneDX", "Tools"]
description: >
  Explains how to use the AI BOM mode of OWASP cdxgen, which generates a CycloneDX SBOM from
  projects and models, together with actual execution output.
---
...
{{% alert title="cdxgen identifies quickly, but a human must fill in the license" color="warning" %}}
