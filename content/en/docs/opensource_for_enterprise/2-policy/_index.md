...
![고지문에 소스 코드 제공 의무 조항과 opensource@sk.com 연락처가 표시된 오픈소스 고지문 예시](./ossnotice.png)
...
![SK텔레콤 오픈소스 사이트에서 OSPO 문의 메일 버튼이 강조 표시된 화면](./website_email.jpg)
...
이러한 오픈소스 기여에 대한 정책은 [부록1] 오픈소스 정책 샘플 [7. 외부 오픈소스 프로젝트 기여](../../templates/1-policy/#7-외부-오픈소스-프로젝트-기여)에서 확인할 수 있습니다. 
...
![ISO/IEC 5230(라이선스 컴플라이언스)과 ISO/IEC DIS 18974(보안 보증) 요구사항을 나란히 놓고 정책 관련 조항을 색으로 강조한 대조표](./spec_number_02.png)
