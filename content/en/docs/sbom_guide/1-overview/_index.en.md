...
type: docs
categories: ["guide"]
tags: ["SBOM", "Software Supply Chain Security"]
description: >
  An overview of what an SBOM is and why it is needed, covering software supply chain threats
  and the benefits an SBOM provides.
---
