---
title: "AI BOM 도구 세트 설계 전략"
linkTitle: "도구 세트 전략"
date: 2026-06-29
weight: 4
type: docs
description: >-
  7개 도구 범주를 공식 리포지토리와 문서로 조사해, 무엇을 재사용·확장·신규 구축할지와
  구축 순서, 매트릭스를 코드화할 정책 스키마, Dependency-Track 통합 아키텍처를 정리합니다.
author: 장학성
categories: ["research"]
...
G7 50요소 각각을 CycloneDX 경로(그리고 장래 SPDX 경로)에 매핑하는 표를 한곳에 둡니다. [「AI BOM 필드 요구사항 매트릭스」]({{< relref "_index.md" >}})가 이미 요소별 출처 매핑을 담고 있으므로, 이를 기계 판독용으로 옮기면 다음과 같은 모양입니다.
