...
이 문서는 자사 개발팀이 AI 모델이나 AI 시스템을 만들 때 작성해야 하는 AI를 위한 자재 명세서(AI Bill of Materials, AI BOM)의 지침입니다. 생산 시점에는 정보 접근성이 가장 좋으므로 요구 수준을 가장 높게 잡습니다. 필수 항목은 [「AI BOM 필드 요구사항 매트릭스」]({{< relref "_index.md" >}})의 생산 열에서 도출했습니다.
